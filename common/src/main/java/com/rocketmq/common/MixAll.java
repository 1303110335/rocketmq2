...
public class MixAll {
    public static final String ROCKETMQ_HOME_ENV = "MY_ROCKETMQ_HOME";
    public static final String ROCKETMQ_HOME_PROPERTY = "myrocketmq.home.dir";
    ...
    public static void main(String[] args) {
        String s = file2String("/Users/xuleyan/learn/myRocketMq/logs/warn.log");
